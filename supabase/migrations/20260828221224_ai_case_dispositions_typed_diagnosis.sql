-- ADDITIVE: the canonical AI case disposition gains one typed pre-writing diagnosis. Existing rows keep
-- theirs (null). The writer COALESCES: a pass that did not rule strips nothing a paid pass banked.
