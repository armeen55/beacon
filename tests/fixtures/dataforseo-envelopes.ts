/**
 * BOUNDED exact-shape DataForSEO response fixtures, transcribed from
 * docs.dataforseo.com on 2026-07-24. Giant arrays are trimmed to 2-3
 * representative items; every field name and nesting level is preserved exactly
 * so the provider-contract tests bind to the REAL envelope, not a guess.
 * Sources are cited inline per fixture.
 */
