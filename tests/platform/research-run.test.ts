...
describe("the cycle finishes stored work before it buys exploratory evidence", () => {
  ...
  it("writes a page off only on its own settled receipt, and never on a blocked, unreached or unreadable pass", async () => {
    const focus = { id: "focus", kind: "existing_edit", status: "needs_review", researchOnly: false, pageUrl: "https://example.com/focus", pagePath: "/focus", changeFamily: "answer_block", recommendedChange: { kind: "existing_edit", field: "answer_block", before: null, after: "" }, obligation: { kind: "draft" } };
