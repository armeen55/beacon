/** Deterministic generators + cross-tenant brain gate (Core 100K Phase 6 merge). */
import { describe, it, expect, vi, beforeEach, afterEach, beforeAll, afterAll } from "vitest";
import { readFileSync, readdirSync, statSync } from "node:fs";
import { join, resolve } from "node:path";
import { type PageElementInventoryRow } from "@/domains/pages/extractors/persist";
import { buildSpecificEditEvidencePacket, type BuildSpecificEditEvidencePacketArgs, type SpecificEditEvidencePacket } from "@/domains/recommendations/specific-edit-evidence";
import { type SpecificEdit } from "@/domains/recommendations/specific-edit-provider";
import { generateEditTitle } from "@/domains/recommendations/providers/generators/edit-title";
import { generateAddH2Section } from "@/domains/recommendations/providers/generators/add-h2-section";
import { generateAddFaq } from "@/domains/recommendations/providers/generators/add-faq";
import { validateSpecificEdit } from "@/domains/recommendations/specific-edit-validator";
import { deterministicProvider, runDeterministicGenerators } from "@/domains/recommendations/providers/deterministic";
...
import { ACTION_TYPES } from "@/domains/recommendations/action-types";
import { isQuestionLike, titleCase } from "@/domains/recommendations/providers/generators/_text-utils";
import { getCrossTenantPatterns, type CrossTenantPattern, type GetCrossTenantPatternsArgs } from "@/domains/recommendations/cross-tenant-brain";

// ===== from src/domains/recommendations/providers/generators/generators.test.ts =====
// ---------------------------------------------------------------------------
...
// ===== from src/domains/recommendations/cross-tenant-brain.test.ts =====
/**
