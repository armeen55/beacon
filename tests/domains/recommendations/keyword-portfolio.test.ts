 ...
 *   • GSC + fanout merge & dedupe into one portfolio;
...
const KEYWORDS: PortfolioInputKeyword[] = [
  ...
  { term: "Koobideh Kabob Recipe", source: "fanout", volume: 2000, difficulty: 22 }, // dup (case)
  { term: "how to grill koobideh", source: "fanout" },
  { term: "buy koobideh kabob skewers", source: "fanout", volume: 500, difficulty: 30 }, // wrong intent
  { term: "persian rug cleaning", source: "fanout", volume: 900, difficulty: 18 }, // adjacent topic
