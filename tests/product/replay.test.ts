...
vi.mock("@/domains/evidence/pages/owned-context", async (orig) => ({ ...(await orig<Record<string, unknown>>()), loadOwnedPageBodies: async (_t: string, urls: string[]) => new Map(urls.map((u) => [u, { url: u, title: "Kite Festival", metaDescription: null, openingSample: "What happens at a kite festival.", cardTexts: [], entityNames: [], internalLinks: [], fetchedAt: "2026-07-20T09:00:00.000Z" }])) }));
