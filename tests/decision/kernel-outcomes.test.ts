...
const reset = (s: EvidenceSnapshot): void => { env.snap = s; env.checked = []; env.pairedFaq = false; env.coverageBody = {}; env.saved = []; env.store = new Map(); env.withdrawn = []; env.failWrites = false; env.failIds = new Set(); env.refuseIds = new Set(); env.withdrawnIds = new Set(); env.bundleTarget = null; env.bundle = null; env.realBundle = false; env.door = null; };
