...
describe("a persisted diagnosis is decoded, never trusted", () => {
  const CONTRACT = 4; // the CURRENT contract, stated literally: a fixture that tracked the constant would pass under any bump and prove nothing about the version rule
