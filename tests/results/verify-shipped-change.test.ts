...
} from "@/domains/proof-gsc/verify-shipped-change";
import type { ShippedChangeRecord, VerifyState, EditDiffRecord } from "@/domains/proof-gsc/shipped-change-store";
...
import type { VerifyAttempt, VerifyEnvelope } from "@/domains/proof-gsc/shipped-change-store";

describe("auto-measure on use: fail-soft scheduling and F6 re-verify selection (folded)", () => {
