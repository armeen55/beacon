...
import {
  ...
  type AutoRecordDeps,
} from "@/domains/proof-gsc/auto-record-on-ship";
import type { ShippedChangeRecord, VerifyEnvelope } from "@/domains/proof-gsc/shipped-change-store";
...
describe("Ship to Proof bridge with injected deps (folded)", () => {
