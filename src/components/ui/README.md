...
- Colors come from tokens only (bg-card, text-muted-foreground, status-*). Raw palette classes (bg-red-50, text-emerald-600) fail `tests/architecture/design-system-guard.test.ts`.
