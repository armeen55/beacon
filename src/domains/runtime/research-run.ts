...
export type ResearchRunProgress = {
  ...
  acquisitions?: readonly { key: string; workKey: string; kind: string; query: string; reasonCode: string; outcome: "unlocked" | "read_not_usable" | "not_read"; detail: string; sharedWith?: readonly string[]; /** The row and the ladder rung this purchase was bought to unlock, straight off the typed need. */ unlocks?: { proposalId: string; step: string } }[];
