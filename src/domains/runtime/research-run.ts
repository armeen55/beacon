...
export type ResearchRunProgress = {
  ...
  evidenceOwed?: readonly (Omit<import("@/domains/decision/producers/contract").EvidenceRequirement, "unlocks"> & { key: string; reason: string; workKey: string; rank?: number; boughtOn?: string; postedOn?: string; tried?: { on: string; work: string; count: number; why: string }; unlocks?: { beforeMicros?: true; proposalId: string; step: string } })[];
