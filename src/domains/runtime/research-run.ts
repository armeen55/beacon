...
export type ResearchRunProgress = {
  ...
  replenish?: { day: string; fingerprint: string; attempted: string[]; tried?: string[]; closed?: "candidates_exhausted"; /** How many times today each `key::family` took real calls and finished nothing; the plan declines a job at two. */ spent?: Record<string, number>;
