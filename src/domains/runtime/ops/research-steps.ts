...
/** Runtime phase contract; each attempt key binds retries to the same unit. */
export type ResearchCycleSteps = {
  ...
  /** One bounded owned-site crawl; incomplete raw captures may use the rendered gateway. */
  ...
  /** Read the evidence watermark after the pass's writes. */
