...
const WRITER = 5; // w5 (2026-08-24): a rewrite target is now the SECTION under its heading, cut out of the body, where before it was a thousand-character crawler chunk that matched nothing. Every page written off under w4 was written off against a target that did not exist, so those settlements say nothing about this policy and reopen.
