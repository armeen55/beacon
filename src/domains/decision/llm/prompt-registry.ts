...
export const PROMPT_REGISTRY = {
  ...
  "draft.body_edit": 4, // 4: the refused shapes are named in the publisher role (2026-09-17); 3: publisher role shared with the final editor.
  ...
  "draft.editor_judgement": 8, // 8: the refused shapes are named in the publisher role (2026-09-17); 7: refuses page talk, self-definitions and copied navigation (2026-09-15); 6: shared publisher-role and material-form acceptance.
