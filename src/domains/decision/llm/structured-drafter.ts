...
const META_SUBJECT_CLAUSE = ' DESCRIBE THE THING THE PAGE IS ABOUT, NEVER THE PAGE. OPEN BY NAMING IT, in the words the page\'s own title and heading use, and include the plain noun for what it is: a reader who sees only your first few words must know what this is. "A limited rebuild of the original vertical stripe design" never says the thing is a shirt. Then say what is true of it: for an item, its real attributes (what it is made of, how it looks, its colour, its cut, its size, what it is for); for a subject, the specific answer the page gives. Take those only from the page\'s own stored words handed to you. NEVER describe the page\'s structure or its sections: no "FAQs", no "frequently asked questions", no shipping, returns, delivery or policy topics, no "on this page", "here you will find", "learn more", and no naming of a question the page asks. If the stored words give you no real attribute, describe the subject plainly and stop; a short true line beats a long one made of furniture. ';
