...
// pure home (domains/evidence/gsc/striking-portfolio.ts) so the per-row badge here and
// the portfolio headline can never disagree. Re-exported for existing callers -
// byte-identical behavior.
import { isStrikingDistance } from "@/domains/evidence/gsc/striking-portfolio";
