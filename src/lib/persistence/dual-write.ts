...
// syncPromptAnswerObservations + its per-day collision recovery removed 2026-08-19 (AEO reconstruction):
// the history projection was a parallel copy of ai_observations, and the ONE canonical record needs no
// second write. The prompt_answer_observations table keeps its rows as history; nothing writes it again.
