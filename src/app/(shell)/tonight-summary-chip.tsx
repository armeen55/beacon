/**
 * TodaySummaryChip (2026-07-02, FP5a; re-homed 2026-07-09 per the operator spec B-7) -
 ...
 */
export function TodaySummaryChip({ picked, applied }: { picked: number; applied: number }) {
  if (picked <= 0) return null;
  return (
    <p
      data-today-summary-chip="true"
