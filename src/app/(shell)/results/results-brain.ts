...
import { isMature, signatureOfShipment, treatmentLearning, type TreatmentGroup } from "@/domains/measurement";
...
const learningRowOf = (p: ShipmentPresentation): LearningRow => ((row: LearningRow): LearningRow => p.read.verdict === "confounded" || judgedOnAi(p) ? { ...row, windows: [] } : row)(p.learning
