...
const REASSURANCE: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Using Beacon and reading your connected data does not add charges. The only outside costs are ones you control: a paid data tool you connect on your own plan (like Profound), and a small amount of AI usage when Beacon drafts wording for you. Beacon never spends or buys anything on your behalf.",
  },
];
