...
export function CockpitJumpNav({ targets }: { targets: JumpTarget[] }) {
  ...
  return (
    <nav className="sticky top-2 z-20 -mx-1 flex flex-wrap gap-1.5 rounded-2xl border border-gray-200/70 bg-white/80 px-2 py-1.5 backdrop-blur supports-[backdrop-filter]:bg-white/60">
