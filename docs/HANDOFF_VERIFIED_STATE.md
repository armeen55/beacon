...
- Production 73,709 lines, tests 12,313, exports 1,319, all at exact ceilings. Final outcome run deployed and verified at `75536c35` (2026-08-17, authenticated prod): backfill self-starts through both product paths and pulled the full history (gsc_daily_rows 2025-04-23 to 2026-08-13, monthly archive rebuilt and self-refreshing), canonical demand units join queries, history, volume, SERP, prompts, answers, citations, fan-outs, winners and coverage with tensions preserved, the demand-recovery producer measures the collapse (persian boy names 834 and girl names 703 lost clicks a month) into ranked cards, AI cards quote the stored answer's own passage, a spending-cap refusal degrades past the paid phase instead of pausing the day, search buying stops at 85 percent of the daily budget so drafting is never starved, and research is ON with the daily $1 cap mechanical.
